...
best_model = joblib.load('xgb_model_filtered_1.pkl')  # Load XGBoost model
scaler_y = joblib.load('y_scaler_filtered_1.pkl')  # Load y-scaler
scaler_X = joblib.load('X_scaler_filtered_1.pkl')  # Load X-scaler
